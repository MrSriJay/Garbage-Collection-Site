...
<asp:Panel ID="greenPost" runat="server">
    <div class="jumbotron container" >
                ...
                <asp:GridView ID="GridView1" CssClass="table" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="getPosts" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" PageSize="5" DataKeyNames="postId" OnRowDataBound="GridView1_RowDataBound">
                    ...
                    <Columns>
                        <asp:CommandField ShowSelectButton="True" HeaderText="Select to Verify" />
                        ...
                        <asp:BoundField DataField="latitude" HeaderText="latitude" SortExpression="latitude" HeaderStyle-CssClass="Hide" ItemStyle-CssClass="Hide">
                        <HeaderStyle CssClass="Hide" />
                        <ItemStyle CssClass="Hide" />
                        </asp:BoundField>
                        <asp:BoundField DataField="longitude" HeaderText="longitude" SortExpression="longitude" HeaderStyle-CssClass="Hide" ItemStyle-CssClass="Hide" >
                        <HeaderStyle CssClass="Hide" />
                        <ItemStyle CssClass="Hide" />
                        </asp:BoundField>
                        <asp:BoundField DataField="datePosted" HeaderText="datePosted" SortExpression="datePosted"  HeaderStyle-CssClass="Hide" ItemStyle-CssClass="Hide">
                        <HeaderStyle CssClass="Hide" />
                        <ItemStyle CssClass="Hide" />
                        </asp:BoundField>
                        <asp:BoundField DataField="validatition" HeaderText="validatition" SortExpression="validatition" > </asp:BoundField>
                ...
                <asp:SqlDataSource ID="getPosts" runat="server" ConnectionString="<%$ ConnectionStrings:CmsConnection %>" SelectCommand="SELECT * FROM [Post] WHERE ([validatition] = @validatition)">
                    <SelectParameters>
                ...
                <div class="card-body container">
                    ...
                    <tr>
                        <td style="height: 32px; width: 902px;">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Select Importance Level" InitialValue="Select Importance Level" ValidationGroup="valG" ControlToValidate="importancelevel" CssClass="text-danger"></asp:RequiredFieldValidator><br />
                            <span class=" font-italic " style ="font-size:14px"><br /><span class="text-danger">* Level 3: Clean immediately</span><br /><span class="text-warning">* Level 2: Clean within a week</span><br /><span class="text-primary">* Level 1: Clean within a month</span> </span>
                        </td>
