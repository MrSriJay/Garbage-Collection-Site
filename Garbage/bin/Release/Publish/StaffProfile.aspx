<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="StaffProfile.aspx.cs" Inherits="Garbage.StaffProfile1" %>
...
<asp:Panel ID="greenPost" runat="server">
    <div class="jumbotron container" >
                ...
                <div class=" container border-success card card-body " >
                 ...
                 <br />
                <asp:GridView ID="GridView1" Width="100%" CssClass="table table-responsive" runat="server" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="postId" CellPadding="4" ForeColor="#333333" GridLines="None">
