...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="container">
    ...
    <table class="table table-striped lead">
        ...
        <tr class="table-light">
            <td style="font-weight:bold; height: 30px;">Upload Images</td>
            <td style="height: 30px; width: 600px;">
                <asp:FileUpload ID="imgUpload"  style="width: 600px; height: 30px;" runat="server" AllowMultiple="True" />
        ...
        <tr>
            ...
            <td style="height: 30px; width: 600px;">        
                <asp:Button ID="Button1" CssClass="btn btn_hover" runat="server" Text="Post" Width="600px" OnClick="Button1_Click" ValidationGroup="Group1" />      
            </td>
            <td>
